> 本文基于 [OpenJDK17](https://zhida.zhihu.com/search?content_id=244652315&content_type=Article&match_order=1&q=OpenJDK17&zhida_source=entity) 进行讨论， [垃圾回收器](https://zhida.zhihu.com/search?content_id=244652315&content_type=Article&match_order=1&q=%E5%9E%83%E5%9C%BE%E5%9B%9E%E6%94%B6%E5%99%A8&zhida_source=entity) 为 ZGC。

**提示：** 为了方便大家索引，特将在上篇文章 [《以 ZGC 为例，谈一谈 JVM 是如何实现 Reference 语义的》](https://link.zhihu.com/?target=https%3A//mp.weixin.qq.com/s%3F__biz%3DMzg2MzU3Mjc3Ng%3D%3D%26mid%3D2247489586%26idx%3D1%26sn%3D4306549c480f668458ab4df0d4b2ea47%26chksm%3Dce77de75f9005763016605e0d268e1a4393a83bfe2a281c915bbf55de99d25cda529195c2843%26token%3D553940664%26lang%3Dzh_CN%23rd) 中讨论的众多主题独立出来。
...
根据 WeakReference 的语义，此时发生了 GC，并且 object1 没有任何强引用链和软引用链，那么此时 JVM 是不是就会将 WeakReference 加入到 \_reference_pending_list 中，后面再由 ReferenceHandler [线程](https://zhida.zhihu.com/search?content_id=244652315&content_type=Article&match_order=1&q=%E7%BA%BF%E7%A8%8B&zhida_source=entity) 转移到 ReferenceQueue 中，等待应用程序的处理。
...
object2 对象在 JVM 堆中被一个 PhantomReference 对象和 FinalReference 对象同时引用，除此之外没有任何强引用链和软引用链，根据 FinalReference 的语义， JVM 会将 [object2](https://zhida.zhihu.com/search?content_id=244652315&content_type=Article&match_order=2&q=object2&zhida_source=entity) 复活。
...
- ZPageTypeSmall 尺寸为 2M ， SmallZPage 中的对象尺寸按照 8 [字节对齐](https://zhida.zhihu.com/search?content_id=244652315&content_type=Article&match_order=1&q=%E5%AD%97%E8%8A%82%E5%AF%B9%E9%BD%90&zhida_source=entity) ，最大允许的对象尺寸为 256K。
...
2. 对象存在强 [引用链](https://zhida.zhihu.com/search?content_id=244652315&content_type=Article&match_order=9&q=%E5%BC%95%E7%94%A8%E9%93%BE&zhida_source=entity) ，人家原本就应该存活，这样 ZGC 会将两个 bit 位全部标记 —— `11` 。
...
发布于 2024-06-19 21:47・广东[Java 虚拟机（JVM）](https://www.zhihu.com/topic/19566470)[JVM](https://www.zhihu.com/topic/19562400)[Java](https://www.zhihu.com/topic/19561132)[博士论文熬到崩溃？我用这 8 个「反内卷」技巧，3 个月写完还盲审全 A](https://zhuanlan.zhihu.com/p/1949455451751162056)

[

凌晨 3 点的实验室，我盯着 Word 文档里 “致谢” 两个字发呆 —— 距离提交博士论文只剩 45 天，可我的第三章数据还没整理完，参考文献格式乱得像一团麻，导师上周批注的 “逻辑不连贯”...

](https://zhuanlan.zhihu.com/p/1949455451751162056)
