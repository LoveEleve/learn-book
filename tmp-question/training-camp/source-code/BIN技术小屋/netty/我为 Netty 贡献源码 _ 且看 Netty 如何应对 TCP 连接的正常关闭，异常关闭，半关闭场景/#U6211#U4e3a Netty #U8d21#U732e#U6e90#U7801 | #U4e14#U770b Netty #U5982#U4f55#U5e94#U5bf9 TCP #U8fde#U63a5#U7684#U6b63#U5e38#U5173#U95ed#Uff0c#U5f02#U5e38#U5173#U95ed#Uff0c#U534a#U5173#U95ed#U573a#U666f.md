...
- **[抓到Netty一个Bug，顺带来透彻地聊一下Netty是如何高效接收网络连接的](https://link.zhihu.com/?target=https%3A//mp.weixin.qq.com/s%3F__biz%3DMzg2MzU3Mjc3Ng%3D%3D%26mid%3D2247484184%26idx%3D1%26sn%3D726877ce28cf6e5d2ac3225fae687f19%26chksm%3Dce77c55ff9004c493b592288819dc4d4664b5949ee97fed977b6558bc517dad0e1f73fab0f46%23rd)** ，在这篇文章中盯出了一个在 Netty 接收网络连接时，影响吞吐量的一个 Bug。
- **[抓到Netty一个隐藏很深的内存泄露Bug | 详解Recycler对象池的精妙设计与实现](https://link.zhihu.com/?target=https%3A//mp.weixin.qq.com/s%3F__biz%3DMzg2MzU3Mjc3Ng%3D%3D%26mid%3D2247484419%26idx%3D1%26sn%3D3a75a495f0f117cca1548da1e0f3e6e6%26chksm%3Dce77c244f9004b52d74b8ffce149ea64e5a8f0ba6713b105d003fdaef8eaa9ad3a5a65d20427%23rd)** ，在这篇文章中盯出了一个 Netty 对象池在多线程并发回收对象时可能导致内存泄露的一个 Bug。

而在本篇文章中笔者又用肉眼盯出了 Netty 在处理 TCP 连接半关闭时的一个 Bug。

![](images/v2-51139171f0269da09db4114bbb8f9018_1440w.png)

image.png

![](images/v2-79c205287ec48539a55136eed4953a0d_1440w.jpg)
...
![](images/v2-fcbb17221bad8e10ba708fef47e6431f_1440w.jpg)

本文概要.png

在笔者前边关于 Netty Reactor 的系列文章中，我们详细的分析了 Reactor 的 **[创建](https://link.zhihu.com/?target=https%3A//mp.weixin.qq.com/s%3F__biz%3DMzg2MzU3Mjc3Ng%3D%3D%26mid%3D2247483907%26idx%3D1%26sn%3D084c470a8fe6234c2c9461b5f713ff30%26chksm%3Dce77c444f9004d52e7c6244bee83479070effb0bc59236df071f4d62e91e25f01715fca53696%23rd)** ， **[启动](https://link.zhihu.com/?target=https%3A//mp.weixin.qq.com/s%3F__biz%3DMzg2MzU3Mjc3Ng%3D%3D%26mid%3D2247484005%26idx%3D1%26sn%3D52f51269902a58f40d33208421109bc3%26chksm%3Dce77c422f9004d340e5b385ef6ba24dfba1f802076ace80ad6390e934173a10401e64e13eaeb%23rd)** ， **[运行](https://link.zhihu.com/?target=https%3A//mp.weixin.qq.com/s%3F__biz%3DMzg2MzU3Mjc3Ng%3D%3D%26mid%3D2247484087%26idx%3D1%26sn%3D0c065780e0f05c23c8e6465ede86cba0%26chksm%3Dce77c4f0f9004de63be369a664105708bc5975b52993f4a6df223caed34cc1ef6185a16acd75%23rd)** ，以及 **[接收网络连接](https://link.zhihu.com/?target=https%3A//mp.weixin.qq.com/s%3F__biz%3DMzg2MzU3Mjc3Ng%3D%3D%26mid%3D2247484184%26idx%3D1%26sn%3D726877ce28cf6e5d2ac3225fae687f19%26chksm%3Dce77c55ff9004c493b592288819dc4d4664b5949ee97fed977b6558bc517dad0e1f73fab0f46%23rd)** ， **[接收网络数据](https://link.zhihu.com/?target=https%3A//mp.weixin.qq.com/s%3F__biz%3DMzg2MzU3Mjc3Ng%3D%3D%26mid%3D2247484244%26idx%3D1%26sn%3D831060fc38caa201d69f87305de7f86a%26chksm%3Dce77c513f9004c05b48f849ff99997d6d7252453135ae856a029137b88aa70b8e046013d596e%23rd)** ，然后通过 **[pipeline 对 IO 事件的编排处理](https://link.zhihu.com/?target=https%3A//mp.weixin.qq.com/s%3F__biz%3DMzg2MzU3Mjc3Ng%3D%3D%26mid%3D2247484823%26idx%3D1%26sn%3D9396fb0f5dbac5e32d0fa1129d385fbc%26chksm%3Dce77c3d0f9004ac678283b7d178835e740eb5e5b80740cc624ae7a307be7a7eb0c7766842878%23rd)** ，最后到 **[发送网络数据](https://link.zhihu.com/?target=https%3A//mp.weixin.qq.com/s%3F__biz%3DMzg2MzU3Mjc3Ng%3D%3D%26mid%3D2247484532%26idx%3D1%26sn%3Dc3a8b37a2eb09509d9914494ef108c68%26chksm%3Dce77c233f9004b25a29f9fdfb179e41646092d09bc89df2147a9fab66df13231e46dd6a5c26d%23rd)** 的一整套流程实现。相信大家通过对这一系列文章的阅读思考，已经对 Reactor 在 Netty 中的实现有了一个全面并且深刻的认识。
...
![](images/v2-2c32fc1eb6369a149fcf7be8e39cec23_1440w.jpg)
...
从上述 TCP 关闭连接的四次挥手步骤中，我们可以看出 Netty 对于关闭连接的响应是通过处理 OP_READ 事件来完成的，而对于 OP_READ 事件的处理，笔者已经在 **[?Netty如何高效接收网络数据](https://link.zhihu.com/?target=https%3A//mp.weixin.qq.com/s%3F__biz%3DMzg2MzU3Mjc3Ng%3D%3D%26mid%3D2247484244%26idx%3D1%26sn%3D831060fc38caa201d69f87305de7f86a%26chksm%3Dce77c513f9004c05b48f849ff99997d6d7252453135ae856a029137b88aa70b8e046013d596e%23rd)** 一文中详细介绍过了，这里我们直接来到 OP_READ 事件的处理函数中，聚焦于连接关闭逻辑的处理。
...
![](images/v2-f3c2d1144d7027db786be907814b65e0_1440w.jpg)
...
![](images/v2-d5c8ece55fc4ca2466b5d83f01284c42_1440w.jpg)
...
![](images/v2-ced42fd8ff599a1e7f1e8a4773a67e02_1440w.jpg)
...
![](images/v2-fb6b9312a680162330e6139f85f83cd4_1440w.jpg)
...
- 当 Socket 发送缓冲区的数据全部发送出去，并等到对端 ACK 后，close 方法返回。- 应用程序在 close 方法上的阻塞时间到达 l_linger 设置的值后，close 方法返回。
  ![](images/v2-24cdb17aec4d5317a64d34dcd343cb9f_1440w.jpg)
...
- `l_onoff = 1，l_linger = 0` ：这种情况下，当应用程序调用 close 方法后会立即返回，随后内核直接清空 Socket 的发送缓冲区，并向对端发送 RST 包，主动关闭方直接跳过四次挥手进入 CLOSE 状态，注意这种情况下是不会有 TIME_WAIT 状态的。
  ![](images/v2-62e24d0579103e2cd2d9fa8751941ed3_1440w.jpg)
...
![](images/v2-71495d17446509ec34eb0c970e8558f0_1440w.jpg)
...
> 关于对 ChannelOutboundBuffer 的详细操作，笔者已经在 **[?一文搞懂 Netty 发送数据全流程](https://link.zhihu.com/?target=https%3A//mp.weixin.qq.com/s%3F__biz%3DMzg2MzU3Mjc3Ng%3D%3D%26mid%3D2247484532%26idx%3D1%26sn%3Dc3a8b37a2eb09509d9914494ef108c68%26chksm%3Dce77c233f9004b25a29f9fdfb179e41646092d09bc89df2147a9fab66df13231e46dd6a5c26d%23rd)** 一文中详细介绍过了，忘记的同学可以在回顾下这篇文章。
...
![](images/v2-13247abc1044057bfbaf82a6d62a19d4_1440w.jpg)
...
![](images/v2-9f541125c177c9c439674fd9dd6c97de_1440w.jpg)
...
![](images/v2-35465beb82930a7d4bd31471cf2b722c_1440w.jpg)
...
- 当 tcp_abort_on_overflow = 0 时，服务端内核协议栈会将该连接标记为 acked 状态，但仍保留在 SYN-Queue 中，并开启 SYN+ACK 重传机制。当 SYN+ACK 包的重传次数超过 net.ipv4.tcp_synack_retries 设置的值时，再将该连接从 SYN queue 中删除。但是此时在客户端的视角来说，连接已经建立成功了。客户端并不知道此时 ACK 包已经被服务端所忽略，如果此时向服务端发送数据的话，服务端会回复 RST 给客户端。
  ![](images/v2-afe13879d4f137d6b978881dcb45e66d_1440w.jpg)

全连接队列满0.png

- 当 tcp_abort_on_overflow = 1 时， 服务端TCP 协议栈直接回复 RST 包，并直接从 SYN-Queue 中删除该连接信息。
  ![](images/v2-d1b48207e6ff25b7a2ef9ee07f70d459_1440w.jpg)
...
![](images/v2-534496ccdfd120d34651f4d3760f67bf_1440w.jpg)
...
![](images/v2-a7d8642ec1be9294fec9787ac1d91836_1440w.jpg)
...
![](images/v2-443e4fa54036a096354d06c5784e9657_1440w.jpg)
...
![](images/v2-f8b8eb37b791b5b293462ae911449b8f_1440w.jpg)
...
![](images/v2-709f5cea3b0a2221069cc3d0e1fbc21f_1440w.jpg)
...
> 如果这里大家已经忘记了相关事件的传播处理流程，可以在回顾下这篇文章 **[?一文聊透 Netty IO 事件的编排利器 pipeline](https://link.zhihu.com/?target=https%3A//mp.weixin.qq.com/s%3F__biz%3DMzg2MzU3Mjc3Ng%3D%3D%26mid%3D2247484823%26idx%3D1%26sn%3D9396fb0f5dbac5e32d0fa1129d385fbc%26chksm%3Dce77c3d0f9004ac678283b7d178835e740eb5e5b80740cc624ae7a307be7a7eb0c7766842878%23rd)** 。
...
![](images/v2-1ec8582c3ffa368e205387f558a80fa8_1440w.jpg)
...
![](images/v2-47850a6b82a653b6b9dd21ee9ae2ffba_1440w.jpg)
...
![](images/v2-6a44c3e2af1286cd935d19e63afa8e97_1440w.jpg)
...
> Issue: [github.com/netty/netty/](https://link.zhihu.com/?target=https%3A//github.com/netty/netty/issues/11981)

![](images/v2-cb0acd860392fdfb4f238d6a01af24a9_1440w.jpg)
...
> PR ： [github.com/netty/netty/](https://link.zhihu.com/?target=https%3A//github.com/netty/netty/pull/11982)

![](images/v2-005cc82732f2ae57152fd467f1bcef54_1440w.jpg)

PR.png

笔者修复后的 ShutdownOutput 流程逻辑如下：

![](images/v2-a9f6132747d6cefc45a8fa796f7dcf21_1440w.jpg)
...
![](images/v2-8a29ccd8a0a1e62f4f20bd89b06ef9d6_1440w.jpg)

image.png

![](images/v2-84629e86bddb0b9a976abca97dd8a4cd_1440w.jpg)

image.png

在 4.1.73.Final 版本发布之后，笔者第一时间拉下来最新的代码，看到 Git 记录中出现了自己的名字，想象着自己的代码跑在了各大知名框架中，还是很有成就感的一件事。

![](images/v2-521a991e4549c796d3683570d4aa0cd3_1440w.jpg)
...
> BUG ： [github.com/netty/netty/](https://link.zhihu.com/?target=https%3A//github.com/netty/netty/issues/11981)
...
发布于 2022-06-16 16:14[Netty](https://www.zhihu.com/topic/19732975)[Java](https://www.zhihu.com/topic/19561132)[TCP](https://www.zhihu.com/topic/19614026)[软件定义的自动化，能否给工业以自由？](https://zhuanlan.zhihu.com/p/1984776624256860827)
