...
在前边的系列文章中，笔者为大家详细剖析了 Reactor 模型在 netty 中的 **[创建](https://link.zhihu.com/?target=https%3A//mp.weixin.qq.com/s%3F__biz%3DMzg2MzU3Mjc3Ng%3D%3D%26mid%3D2247483907%26idx%3D1%26sn%3D084c470a8fe6234c2c9461b5f713ff30%26chksm%3Dce77c444f9004d52e7c6244bee83479070effb0bc59236df071f4d62e91e25f01715fca53696%23rd)** ， **[启动](https://link.zhihu.com/?target=https%3A//mp.weixin.qq.com/s%3F__biz%3DMzg2MzU3Mjc3Ng%3D%3D%26mid%3D2247484005%26idx%3D1%26sn%3D52f51269902a58f40d33208421109bc3%26chksm%3Dce77c422f9004d340e5b385ef6ba24dfba1f802076ace80ad6390e934173a10401e64e13eaeb%23rd)** ， **[运行](https://link.zhihu.com/?target=https%3A//mp.weixin.qq.com/s%3F__biz%3DMzg2MzU3Mjc3Ng%3D%3D%26mid%3D2247484087%26idx%3D1%26sn%3D0c065780e0f05c23c8e6465ede86cba0%26chksm%3Dce77c4f0f9004de63be369a664105708bc5975b52993f4a6df223caed34cc1ef6185a16acd75%23rd)** ， **[接收连接](https://link.zhihu.com/?target=https%3A//mp.weixin.qq.com/s%3F__biz%3DMzg2MzU3Mjc3Ng%3D%3D%26mid%3D2247484184%26idx%3D1%26sn%3D726877ce28cf6e5d2ac3225fae687f19%26chksm%3Dce77c55ff9004c493b592288819dc4d4664b5949ee97fed977b6558bc517dad0e1f73fab0f46%23rd)** ， **[接收数据](https://link.zhihu.com/?target=https%3A//mp.weixin.qq.com/s%3F__biz%3DMzg2MzU3Mjc3Ng%3D%3D%26mid%3D2247484244%26idx%3D1%26sn%3D831060fc38caa201d69f87305de7f86a%26chksm%3Dce77c513f9004c05b48f849ff99997d6d7252453135ae856a029137b88aa70b8e046013d596e%23rd)** ， **[发送数据](https://link.zhihu.com/?target=https%3A//mp.weixin.qq.com/s%3F__biz%3DMzg2MzU3Mjc3Ng%3D%3D%26mid%3D2247484532%26idx%3D1%26sn%3Dc3a8b37a2eb09509d9914494ef108c68%26chksm%3Dce77c233f9004b25a29f9fdfb179e41646092d09bc89df2147a9fab66df13231e46dd6a5c26d%23rd)** 的完整流程，在详细剖析整个 Reactor 模型如何在 netty 中实现的过程里，我们或多或少的见到了 pipeline 的身影。
...
又比如在 Reactor 接收连接的过程中，当客户端发起一个连接并完成三次握手之后，连接对应的 Socket 会存放在内核中的 [全连接队列](https://zhida.zhihu.com/search?content_id=202599000&content_type=Article&match_order=1&q=%E5%85%A8%E8%BF%9E%E6%8E%A5%E9%98%9F%E5%88%97&zhida_source=entity) 中，随后 JDK Selector 会通知 main reactor 此时 NioServerSocketChannel 上有 OP_ACCEPT 事件活跃，最后 main reactor 开始执行 NioServerSocketChannel 的底层操作类 NioMessageUnsafe#read 方法在 NioServerSocketChannel 中的 pipeline 中传播 ChannelRead 事件。
...
还有在 **[《Netty如何高效接收网络数据》](https://link.zhihu.com/?target=https%3A//mp.weixin.qq.com/s%3F__biz%3DMzg2MzU3Mjc3Ng%3D%3D%26mid%3D2247484244%26idx%3D1%26sn%3D831060fc38caa201d69f87305de7f86a%26chksm%3Dce77c513f9004c05b48f849ff99997d6d7252453135ae856a029137b88aa70b8e046013d596e%23rd)** 一文中，我们也提过当 sub reactor 读取 NioSocketChannel 中来自客户端的请求数据时，会在 NioSocketChannel 的 pipeline 中传播 ChannelRead 事件，在一个完整的 read loop 读取完毕后会传播 ChannelReadComplete 事件。

在 **[《一文搞懂Netty发送数据全流程》](https://link.zhihu.com/?target=https%3A//mp.weixin.qq.com/s%3F__biz%3DMzg2MzU3Mjc3Ng%3D%3D%26mid%3D2247484532%26idx%3D1%26sn%3Dc3a8b37a2eb09509d9914494ef108c68%26chksm%3Dce77c233f9004b25a29f9fdfb179e41646092d09bc89df2147a9fab66df13231e46dd6a5c26d%23rd)** 一文中，我们讲到了在用户经过业务处理后，通过 write 方法和 flush 方法分别在 NioSocketChannel 的 pipeline 中传播 write 事件和 flush 事件的过程。
...
![](images/v2-23a1140c0523eac2261727797beef394_1440w.jpg)
...
前边介绍到 NioServerSocketChannel 是在 netty [服务端](https://zhida.zhihu.com/search?content_id=202599000&content_type=Article&match_order=1&q=%E6%9C%8D%E5%8A%A1%E7%AB%AF&zhida_source=entity) 启动的过程中创建的。而 NioSocketChannel 的创建是在当 NioServerSocketChannel 上的 OP_ACCEPT 事件活跃时，由 main reactor 线程在 NioServerSocketChannel 中创建，并在 NioServerSocketChannel 的 pipeline 中对 OP_ACCEPT 事件进行编排时（图中的 ServerBootstrapAcceptor 中）初始化的。

无论是创建 NioServerSocketChannel 里的 pipeline 还是创建 NioSocketChannel 里的 pipeline, 最终都会委托给它们的父类 AbstractChannel 。

![](images/v2-1947b8353a4a0a4e7215fa2dd8cdacea_1440w.jpg)
...
![](images/v2-0d98965ce3e84fc0e81def42a5b803cd_1440w.jpg)
...
> 在**[?《一文搞懂Netty发送数据全流程》](https://link.zhihu.com/?target=https%3A//mp.weixin.qq.com/s%3F__biz%3DMzg2MzU3Mjc3Ng%3D%3D%26mid%3D2247484532%26idx%3D1%26sn%3Dc3a8b37a2eb09509d9914494ef108c68%26chksm%3Dce77c233f9004b25a29f9fdfb179e41646092d09bc89df2147a9fab66df13231e46dd6a5c26d%23rd)** 一文中的《1. ChannelHandlerContext》小节中，笔者曾为大家详细介绍过 ChannelHandlerContext 在 pipeline 中的作用，忘记的同学可以在回看下。
...
比如我们在**[?《Reactor在Netty中的实现(启动篇)》](https://link.zhihu.com/?target=https%3A//mp.weixin.qq.com/s%3F__biz%3DMzg2MzU3Mjc3Ng%3D%3D%26mid%3D2247484005%26idx%3D1%26sn%3D52f51269902a58f40d33208421109bc3%26chksm%3Dce77c422f9004d340e5b385ef6ba24dfba1f802076ace80ad6390e934173a10401e64e13eaeb%23rd)** 中介绍的 NioServerSocketChannel 在向 main reactor 注册完成后会触发 ChannelRegistered 事件从 HeadContext 开始依次在 pipeline 中向后传播。
...
在**[?《一文搞懂Netty发送数据全流程》](https://link.zhihu.com/?target=https%3A//mp.weixin.qq.com/s%3F__biz%3DMzg2MzU3Mjc3Ng%3D%3D%26mid%3D2247484532%26idx%3D1%26sn%3Dc3a8b37a2eb09509d9914494ef108c68%26chksm%3Dce77c233f9004b25a29f9fdfb179e41646092d09bc89df2147a9fab66df13231e46dd6a5c26d%23rd)** 中介绍的 write 事件和 flush 事件最终会在 pipeline 中从后向前一直传播到 HeadContext ，并在 HeadContext 中相应事件 [回调函数](https://zhida.zhihu.com/search?content_id=202599000&content_type=Article&match_order=2&q=%E5%9B%9E%E8%B0%83%E5%87%BD%E6%95%B0&zhida_source=entity) 中调用 unsafe 类操作底层 channel 发送数据。
...
因为 inbound 事件一般都是由 netty 内核触发传播的，而 outbound 事件一般都是由用户选择触发的，比如用户在处理完 [业务逻辑](https://zhida.zhihu.com/search?content_id=202599000&content_type=Article&match_order=1&q=%E4%B8%9A%E5%8A%A1%E9%80%BB%E8%BE%91&zhida_source=entity) 触发的 write 事件或者 flush 事件。

而在用户触发 [outbound](https://zhida.zhihu.com/search?content_id=202599000&content_type=Article&match_order=10&q=outbound&zhida_source=entity) 事件后，一般都会得到一个 ChannelPromise 。用户可以向 ChannelPromise 添加各种 listener 。当 outbound 事件在传播的过程中发生异常时，netty 会通知用户持有的这个 ChannelPromise ， **但不会触发 exceptionCaught 的回调** 。

比如我们在**[?《一文搞懂Netty发送数据全流程》](https://link.zhihu.com/?target=https%3A//mp.weixin.qq.com/s%3F__biz%3DMzg2MzU3Mjc3Ng%3D%3D%26mid%3D2247484532%26idx%3D1%26sn%3Dc3a8b37a2eb09509d9914494ef108c68%26chksm%3Dce77c233f9004b25a29f9fdfb179e41646092d09bc89df2147a9fab66df13231e46dd6a5c26d%23rd)** 一文中介绍到的在 write 事件传播的过程中就不会触发 exceptionCaught 事件回调。只是去通知用户的 ChannelPromise 。
...
![](images/v2-5c0342740ff9ae09b5a95dfae03b627a_1440w.jpg)

Netty接收网络数据流程.png

**这里需要注意的是当 ChannelReadComplete 事件触发时，此时并不代表 NioSocketChannel 中的请求数据已经读取完毕** ，可能的情况是发送的请求数据太多，在一个 read loop 中读取不完达到了最大限制次数 16 次，还没全部读取完毕就退出了 read loop 。一旦退出 read loop 就会触发 ChannelReadComplete 事件。详细内容可以查看笔者的这篇文章**[?《Netty如何高效接收网络数据》](https://link.zhihu.com/?target=https%3A//mp.weixin.qq.com/s%3F__biz%3DMzg2MzU3Mjc3Ng%3D%3D%26mid%3D2247484244%26idx%3D1%26sn%3D831060fc38caa201d69f87305de7f86a%26chksm%3Dce77c513f9004c05b48f849ff99997d6d7252453135ae856a029137b88aa70b8e046013d596e%23rd)** 。
...
![](images/v2-03c1df20bae3ff4758c0426da14295cd_1440w.jpg)
...
![](images/v2-620030bbe300714d77a8b56a3283b41c_1440w.jpg)
...
其实这是 netty 为大家提供的一种 [背压机制](https://zhida.zhihu.com/search?content_id=202599000&content_type=Article&match_order=1&q=%E8%83%8C%E5%8E%8B%E6%9C%BA%E5%88%B6&zhida_source=entity) ，用来防止 OOM ，想象一下当对端发送数据非常多并且发送速度非常快，而服务端处理速度非常慢，一时间消费不过来。而对端又在不停的大量发送数据，服务端的 reactor 线程不得不在 read loop 中不停的读取，并且为读取到的数据分配 ByteBuffer 。而服务端业务线程又处理不过来，这就导致了大量来不及处理的数据占用了大量的内存空间，从而导致 OOM 。
...
write 事件和 flush 事件我们在**[?《一文搞懂Netty发送数据全流程》](https://link.zhihu.com/?target=https%3A//mp.weixin.qq.com/s%3F__biz%3DMzg2MzU3Mjc3Ng%3D%3D%26mid%3D2247484532%26idx%3D1%26sn%3Dc3a8b37a2eb09509d9914494ef108c68%26chksm%3Dce77c233f9004b25a29f9fdfb179e41646092d09bc89df2147a9fab66df13231e46dd6a5c26d%23rd)** 一文中已经非常详尽的介绍过了，这里笔者在带大家简单回顾一下。
...
最终通过 flush 操作从 Channel 中的写 [缓冲队列](https://zhida.zhihu.com/search?content_id=202599000&content_type=Article&match_order=4&q=%E7%BC%93%E5%86%B2%E9%98%9F%E5%88%97&zhida_source=entity) ChannelOutboundBuffer 中获取到待发送数据，并写入到 Socket 的发送缓冲区中。
...
因为向 pipeline 中添加 channelHandler 的操作可能会在多个线程中进行，所以为了确保添加操作的 [线程安全](https://zhida.zhihu.com/search?content_id=202599000&content_type=Article&match_order=1&q=%E7%BA%BF%E7%A8%8B%E5%AE%89%E5%85%A8&zhida_source=entity) 性，这里采用一个 synchronized 语句块将整个添加逻辑包裹起来。
...
![](images/v2-f44f1350505bfcf43d9d21addc03f1cd_1440w.jpg)
...
![](images/v2-74a281e945b8707b70da6f6640d42dbd_1440w.jpg)

channelhandelr的状态.png

在上篇文章**[?《一文搞懂Netty发送数据全流程》](https://link.zhihu.com/?target=https%3A//mp.weixin.qq.com/s%3F__biz%3DMzg2MzU3Mjc3Ng%3D%3D%26mid%3D2247484532%26idx%3D1%26sn%3Dc3a8b37a2eb09509d9914494ef108c68%26chksm%3Dce77c233f9004b25a29f9fdfb179e41646092d09bc89df2147a9fab66df13231e46dd6a5c26d%23rd)** 中的《3.1.5 触发nextChannelHandler的write方法回调》小节中我们也提过，在每次 write 事件或者 flush 事件传播的时候，都需要通过 invokeHandler 方法来判断 channelHandler 的状态是否为 ADD_COMPLETE ，否则当前 channelHandler 则不能响应正在 pipeline 中传播的事件。 **必须要等到对应的 handlerAdded 方法被回调才可以，因为 handlerAdded 方法中可能包含一些 ChannelHandler 初始化的重要逻辑。**
...
![](images/v2-f43c8850a7771b2ac287eca33ff1d6c1_1440w.jpg)
...
> EventExecutorGroup 是 netty 自定义的一个 [线程池](https://zhida.zhihu.com/search?content_id=202599000&content_type=Article&match_order=1&q=%E7%BA%BF%E7%A8%8B%E6%B1%A0&zhida_source=entity) 模型，其中包含多个 EventExecutor ，而 EventExecutor 在 netty 中是一个线程的执行模型。相关的具体实现和用法笔者已经在**[?《Reactor在Netty中的实现(创建篇)》](https://link.zhihu.com/?target=https%3A//mp.weixin.qq.com/s%3F__biz%3DMzg2MzU3Mjc3Ng%3D%3D%26mid%3D2247483907%26idx%3D1%26sn%3D084c470a8fe6234c2c9461b5f713ff30%26chksm%3Dce77c444f9004d52e7c6244bee83479070effb0bc59236df071f4d62e91e25f01715fca53696%23rd)** 一文中给出了详尽的介绍，忘记的同学可以在回顾下。
...
eventExecutorGroup 中包含 EventExecutor1，EventExecutor2 ， EventExecutor3 三个 [执行线程](https://zhida.zhihu.com/search?content_id=202599000&content_type=Article&match_order=2&q=%E6%89%A7%E8%A1%8C%E7%BA%BF%E7%A8%8B&zhida_source=entity) 。
...
![](images/v2-cb26efb72b9539d1915a44d0d69b9f3c_1440w.jpg)
...
![](images/v2-e9975a861d3210360c0456f04b501a34_1440w.jpg)
...
![](images/v2-0ca155fda53c3fecc6e52593aaa8661d_1440w.jpg)
...
当我们不指定 channelHandler 的 [executor](https://zhida.zhihu.com/search?content_id=202599000&content_type=Article&match_order=36&q=executor&zhida_source=entity) 时或者指定的 executor 类型为 OrderedEventExecutor 时，ordered = true。
...
1. 如果此时 channel 并未向对应的 reactor 进行注册，则需要向 pipeline 的任务列表中添加 PendingHandlerRemovedTask 任务，再该任务中会执行 ChannelHandler 的 handlerRemoved 回调，当 channel 向 reactor 注册成功后，reactor 会执行 pipeline 中任务列表中的任务，从而回调被删除 ChannelHandler 的 handlerRemoved 方法。
   ![](images/v2-66c3750b2210c43ce955e55788879424_1440w.jpg)
...
其实关于 pipeline 初始化的相关内容我们在**[?《详细图解 Netty Reactor 启动全流程》](https://link.zhihu.com/?target=https%3A//mp.weixin.qq.com/s%3F__biz%3DMzg2MzU3Mjc3Ng%3D%3D%26mid%3D2247484005%26idx%3D1%26sn%3D52f51269902a58f40d33208421109bc3%26chksm%3Dce77c422f9004d340e5b385ef6ba24dfba1f802076ace80ad6390e934173a10401e64e13eaeb%23rd)** 中已经简要介绍了 NioServerSocketChannel 中的 pipeline 的初始化时机以及过程。

在**[?《Netty 如何高效接收网络连接》](https://link.zhihu.com/?target=https%3A//mp.weixin.qq.com/s%3F__biz%3DMzg2MzU3Mjc3Ng%3D%3D%26mid%3D2247484184%26idx%3D1%26sn%3D726877ce28cf6e5d2ac3225fae687f19%26chksm%3Dce77c55ff9004c493b592288819dc4d4664b5949ee97fed977b6558bc517dad0e1f73fab0f46%23rd)** 中笔者也简要介绍了 NioSocketChannel 中 pipeline 的初始化时机以及过程。
...
> 忘记 netty 启动过程的同学可以在回看下笔者的**[?《详细图解 Netty Reactor 启动全流程》](https://link.zhihu.com/?target=https%3A//mp.weixin.qq.com/s%3F__biz%3DMzg2MzU3Mjc3Ng%3D%3D%26mid%3D2247484005%26idx%3D1%26sn%3D52f51269902a58f40d33208421109bc3%26chksm%3Dce77c422f9004d340e5b385ef6ba24dfba1f802076ace80ad6390e934173a10401e64e13eaeb%23rd)** 这篇文章。
...
![](images/v2-5cb723e9dfb3c1e6590c85420e170404_1440w.jpg)
...
随后 netty 会以 [异步任务](https://zhida.zhihu.com/search?content_id=202599000&content_type=Article&match_order=1&q=%E5%BC%82%E6%AD%A5%E4%BB%BB%E5%8A%A1&zhida_source=entity) 的形式向 pipeline 的末尾添加 ServerBootstrapAcceptor ，至此 NioServerSocketChannel 中 pipeline 的初始化工作就全部完成了。
...
在**[?《Netty 如何高效接收网络连接》](https://link.zhihu.com/?target=https%3A//mp.weixin.qq.com/s%3F__biz%3DMzg2MzU3Mjc3Ng%3D%3D%26mid%3D2247484184%26idx%3D1%26sn%3D726877ce28cf6e5d2ac3225fae687f19%26chksm%3Dce77c55ff9004c493b592288819dc4d4664b5949ee97fed977b6558bc517dad0e1f73fab0f46%23rd)** 一文中我们介绍过，当客户端发起连接，完成三次握手之后，NioServerSocketChannel 上的 OP_ACCEPT 事件活跃，随后会在 NioServerSocketChannel 的 pipeline 中触发 channelRead 事件。并最终在 ServerBootstrapAcceptor 中初始化客户端 NioSocketChannel 。
...
![](images/v2-53129b34057d7f84902b9c5540235944_1440w.jpg)
...
> 在执行 ChannelHandler 中的相应事件 [回调方法](https://zhida.zhihu.com/search?content_id=202599000&content_type=Article&match_order=18&q=%E5%9B%9E%E8%B0%83%E6%96%B9%E6%B3%95&zhida_source=entity) 时，需要确保回调方法的执行在指定的 executor 中进行。
...
如果 ChannelRead 事件在 pipeline 中传播的过程中，没有得到其他 ChannelInboundHandler 的有效处理，最终会被传播到 pipeline 的末尾 TailContext 中。而在本文第二小节中，我们也提到过 TailContext 对于 [inbound](https://zhida.zhihu.com/search?content_id=202599000&content_type=Article&match_order=35&q=inbound&zhida_source=entity) 事件存在的意义就是做一个兜底的处理。比如：打印日志，释放 [bytebuffer](https://zhida.zhihu.com/search?content_id=202599000&content_type=Article&match_order=1&q=bytebuffer&zhida_source=entity) 。
...
本小节要介绍的 findContextInbound 方法和我们在上篇文章**[?《一文聊透 Netty 发送数据全流程》](https://link.zhihu.com/?target=https%3A//mp.weixin.qq.com/s%3F__biz%3DMzg2MzU3Mjc3Ng%3D%3D%26mid%3D2247484532%26idx%3D1%26sn%3Dc3a8b37a2eb09509d9914494ef108c68%26chksm%3Dce77c233f9004b25a29f9fdfb179e41646092d09bc89df2147a9fab66df13231e46dd6a5c26d%23rd)** 中介绍的 findContextOutbound 方法均是 netty 异步事件在 pipeline 中传播的核心所在。
...
- 当 `ctx.executor() != currentExecutor ` 也就是前后两个 ChannelHandler 指定的 executor 不同时， **语义变为：只要前后两个 ChannelHandler 指定的 executor 不同，不管下一个ChannelHandler有没有覆盖实现 [指定事件](https://zhida.zhihu.com/search?content_id=202599000&content_type=Article&match_order=1&q=%E6%8C%87%E5%AE%9A%E4%BA%8B%E4%BB%B6&zhida_source=entity) 的回调方法，均不能跳过。** 在这种情况下会执行到 ChannelHandler 的默认事件回调方法，继续在 pipeline 中传递事件。我们在《5.3 ChanneHandlerContext》小节提到过 ChannelInboundHandlerAdapter 和 ChannelOutboundHandlerAdapter 会分别对 inbound 类事件回调方法和 outbound 类事件回调方法进行默认的实现。
...
关于 Outbound 类事件的传播，笔者在上篇文章**[?《一文搞懂 Netty 发送数据全流程》](https://link.zhihu.com/?target=https%3A//mp.weixin.qq.com/s%3F__biz%3DMzg2MzU3Mjc3Ng%3D%3D%26mid%3D2247484532%26idx%3D1%26sn%3Dc3a8b37a2eb09509d9914494ef108c68%26chksm%3Dce77c233f9004b25a29f9fdfb179e41646092d09bc89df2147a9fab66df13231e46dd6a5c26d%23rd)** 中已经进行了详细的介绍，本小节就不在赘述。

### 8.5 ExceptionCaught事件的传播

在最后我们来介绍下异常事件在 pipeline 中的传播，ExceptionCaught 事件和 Inbound 类事件一样都是在 pipeline 中从前往后开始传播。

ExceptionCaught 事件的触发有两种情况：一种是 [netty](https://zhida.zhihu.com/search?content_id=202599000&content_type=Article&match_order=46&q=netty&zhida_source=entity) 框架内部产生的异常，这时 netty 会直接在 pipeline 中触发 ExceptionCaught 事件的传播。异常事件会在 pipeline 中从 HeadContext 开始一直向后传播直到 TailContext。
...
我们可以在 ChannelHandler 的 exceptionCaught 回调中进行 [异常处理](https://zhida.zhihu.com/search?content_id=202599000&content_type=Article&match_order=1&q=%E5%BC%82%E5%B8%B8%E5%A4%84%E7%90%86&zhida_source=entity) ，并决定是否通过 ctx.fireExceptionCaught(cause) 继续向后传播异常事件。
...
**在 Inbound 类事件 [传播过程](https://zhida.zhihu.com/search?content_id=202599000&content_type=Article&match_order=1&q=%E4%BC%A0%E6%92%AD%E8%BF%87%E7%A8%8B&zhida_source=entity) 中是会查找下一个具有 [事件响应](https://zhida.zhihu.com/search?content_id=202599000&content_type=Article&match_order=1&q=%E4%BA%8B%E4%BB%B6%E5%93%8D%E5%BA%94&zhida_source=entity) 资格的 ChannelInboundHandler 。遇到 ChannelOutboundHandler 会直接跳过。**
...
![](images/v2-832e169511d57fddbcb8d0a99ed65fb5_1440w.jpg)
...
本文中我们详细介绍了 pipeline 的组成结构，它主要是由 ChannelHandlerContext 类型节点组成的双向链表。ChannelHandlerContext 包含了 ChannelHandler 执行上下文的信息，从而可以使 ChannelHandler 只关注于 IO 事件的处理，遵循了单一原则和 [开闭原则](https://zhida.zhihu.com/search?content_id=202599000&content_type=Article&match_order=1&q=%E5%BC%80%E9%97%AD%E5%8E%9F%E5%88%99&zhida_source=entity) 。
...
发布于 2022-05-16 13:11[Netty](https://www.zhihu.com/topic/19732975)[Java](https://www.zhihu.com/topic/19561132)[网络编程](https://www.zhihu.com/topic/19611616)[别被 “改论文” 的大压力困住，从最容易的格式校对开始，动起来就会发现没那么难～](https://zhuanlan.zhihu.com/p/1955636345054671203)

[

一提改论文，不少人脑袋都大了 —— 对着满屏的文字，一会儿担心逻辑不通，一会儿怕数据不对，越想越觉得无从下手，干脆往那儿一放，拖到最后急得跳脚。其实真不用把自己逼得那么紧...

](https://zhuanlan.zhihu.com/p/1955636345054671203)
