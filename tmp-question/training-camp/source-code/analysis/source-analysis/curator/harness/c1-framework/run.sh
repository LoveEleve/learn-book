...
echo "== 编译 =="
javac -cp "$CP" -d /tmp/c1harness HarnessC1.java || exit 1
echo "== 运行 =="
java -cp "/tmp/c1harness$CP" -Dorg.slf4j.simpleLogger.defaultLogLevel=warn HarnessC1
