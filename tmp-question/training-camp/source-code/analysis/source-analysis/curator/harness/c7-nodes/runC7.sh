...
echo "== 编译 =="
javac -cp "$CP" -d /tmp/c7harness HarnessC7.java || exit 1
echo "== 运行 =="
java -cp "/tmp/c7harness$CP" -Dzookeeper.extendedTypesEnabled=true -Dorg.slf4j.simpleLogger.defaultLogLevel=warn HarnessC7
