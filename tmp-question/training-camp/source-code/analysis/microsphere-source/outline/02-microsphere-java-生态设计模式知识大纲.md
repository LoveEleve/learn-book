...
> 来源：`mapping/02-microsphere-java.md` 46 个 KP 的知识本体提炼
...
| 二、注解与编译期 | 101,102,103,104,105,109,144,146 | 8 |
...
| 六、版本与兼容 | 132,133 | 2 |
| 七、类加载与构件 | 130,131,134,135,140,141,142,143,145 | 9 |
| 八、演进与移植 | 跨仓库汇总 | — |

**去重后唯一 KP**：101-146 全部 = **46/46 ✓**（KP-130 双归属 三/七；KP-121/122 双归属 一/三）
**无孤儿 KP** ✓（KP-106/107/108 属性解析归四；KP-131 Assert 归七；KP-135 归七）
