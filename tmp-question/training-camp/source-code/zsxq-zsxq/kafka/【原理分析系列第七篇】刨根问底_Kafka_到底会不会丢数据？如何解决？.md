...
![](https://article-images.zsxq.com/FrB9TWm5t6XIQJEO62x1Hk0HCP45)
...
![](https://article-images.zsxq.com/FpySCTR6vbLfM3VAnYWdgP5xPXpH)
...
![](https://article-images.zsxq.com/Fu17gM5xHhu0G25Q_SIG6HPIP48Z)
...
在剖析 Producer 端数据丢失之前，我们先来了解下 Producer 端发送消息的流程，对于不了解 Producer 的读者们，可以查看 **[聊聊 Kafka Producer 那点事](https://articles.zsxq.com/id_6l0nnnuud8hr.html)**

![](https://article-images.zsxq.com/Flsz600_gUW8NgVPkvLjI6nEagIM)
...
![](https://article-images.zsxq.com/Fgn8GXSUXrkiSC3JDDQNqLW6Fc7Z)

![](https://article-images.zsxq.com/FvGo8c4KyUzBKn3CMYxECkL_ExvB)
...
接下来我们来看看 Broker 端持久化存储丢失场景， 对于不了解 Broker 的读者们，可以先看看 **[聊聊 Kafka Broker 那点事](https://articles.zsxq.com/id_v013euqkznz3.html)**，数据存储过程如下图所示：

![](https://article-images.zsxq.com/FvmbrnJjuTBKHInoNxK3UhI-S2q1)
...
接下来我们来看看 Consumer 端消费数据丢失场景，对于不了解 Consumer 的读者们，可以先看看 **[聊聊 Kafka Consumer 那点事](https://articles.zsxq.com/id_xqh2l0kkhc7a.html)**, 我们先来看看消费流程：

![](https://article-images.zsxq.com/FkksImxxhlnk1NN7DwXW3TXl8-5w)

![](https://article-images.zsxq.com/FqIvrYHnXBaEjR5RGCGGNMJSH3F3)
...
![](https://article-images.zsxq.com/FgxBJ5vfCLDXIZrsEmMjLyiqV4kO)
...
![](https://article-images.zsxq.com/Fk6MM6wuhVG_ZGMm3ffREemaPqaD)
...
需要将 retries 设置为大于0的数， 在 Kafka 2.4 版本中默认设置为Integer.MAX\_VALUE。另外如果需要保证发送消息的顺序性，配置如下：

retries = Integer.MAX\_VALUE
